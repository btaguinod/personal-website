    ...
    return (
        <div className="page" id="about">
            <div className="page-text" id="about-text">
                ...
                <div className="subtext-2">I'm an EECS student at <span className="highlight"><a href="https://www.linkedin.com/school/uc-berkeley/"> UC Berkeley</a></span> and a former software engineer intern at <span className="highlight"><a href="https://www.hpe.com/us/en/home.html"> HPE</a></span></div>
